...
const TabsAdvancedBackground = () => {
  ...
  const setCurrentTab = (currentTab: TabsState['currentTab']) =>
    setTabState({ ...tabState, currentTab });
  const setIntentIndicator = (intentAt: TabsState['intentAt']) =>
    setTabState({ ...tabState, intentAt });
  const setActiveIndicator = (activeAt: TabsState['activeAt']) =>
  ...
  return (
    <Tabs
      ...
      <AnimatePresence exitBeforeEnter enterVariant={enterVariant} exitVariant={exitVariant}>
        <AnimatedYStack key={currentTab} animation="quick" x={0} opacity={1} flex={1}>
